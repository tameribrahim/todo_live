defmodule TodoLiveWeb.TodoLiveTest do
  use TodoLiveWeb.ConnCase

  import Phoenix.LiveViewTest
  import TodoLive.TodosFixtures

  @create_attrs %{done_at: %{day: 5, month: 9, year: 2021}, due_at: %{day: 5, month: 9, year: 2021}, title: "some title"}
  @update_attrs %{done_at: %{day: 6, month: 9, year: 2021}, due_at: %{day: 6, month: 9, year: 2021}, title: "some updated title"}
  @invalid_attrs %{done_at: %{day: 30, month: 2, year: 2021}, due_at: %{day: 30, month: 2, year: 2021}, title: nil}
